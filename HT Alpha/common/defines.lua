...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.03, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.15, -- fraction of ships in the navy that should be cruisers, frigates etc
	AI_TRANSPORT_PROPORTION = 0.82, -- fraction of ships in the navy that should be should be transports
	...
	AI_ESCORT_RATIO = 0.25, -- ratio of escorts to transports in invasion fleets
