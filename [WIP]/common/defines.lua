...
country = {
	...
	MOBILIZATION_SPEED_BASE = 0.15, -- Base speed for raising troops
	...
	MAX_RESEARCH_POINTS = 100000, -- max RP you can store for uncivs
},
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 6000,
...
ai =
{
	...
	NAVAL_SUPPLY_PENALTY_LIMIT = 0.25, -- AI will allow to have max X% of supply penalty (when too little naval bases)
	CHANCE_BUILD_RAILROAD = 1.0, -- chances in % of AI decisions (max value 1.0)
	...
	PEACE_TIME_MONTHS = 0, -- months of additional AI stubbornness in a war
	PEACE_TIME_FACTOR = 0.5, -- after months of stubbornness the effect of time passed is multiplied by this
	PEACE_TIME_FACTOR_NO_GOALSPEACE_TIME_FACTOR_NO_GOALS = 1, -- this extra time factor is applied after PEACE_TIME_FACTOR if we ahve no wargoals
	...
	PEACE_ALLY_BASE_RELUCTANCE_MULT = 0, -- Multiplies PEACE_BASE_RELUCTANCE for allies in a war
	...
	PEACE_ALLY_WAR_DIRECTION_MULT = 5.0, -- Multiplies PEACE_WAR_DIRECTION_FACTOR for allies in a war
	...
	FLEET_SIZE = 100, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
